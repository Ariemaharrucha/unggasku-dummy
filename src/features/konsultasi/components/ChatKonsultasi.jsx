        ...
        <div className="bg-secondary-300 w-full py-2 px-32">
          <div className="flex items-center">
            <div className="w-14 h-14 overflow-hidden rounded-full border-2 border-black">
              <img className="object-cover object-top" src={image_dokter1} alt="Dokter" />
            </div>
            <div className="flex flex-col">
              <h3 className="text-md font-bold pl-3">Dokter</h3>
              <p className="text-sm pl-3 opacity-50">Spesialis Unggas</p>
              <p className="text-sm pl-3 opacity-50">08:00 - 16:00</p>
            </div>
          </div>
        </div>
